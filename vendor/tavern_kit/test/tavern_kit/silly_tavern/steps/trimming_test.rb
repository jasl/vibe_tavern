...
class TavernKit::SillyTavern::PromptBuilder::Steps::TrimmingTest < Minitest::Test
  class CharEstimator
  ...
  def test_trimming_disables_removable_blocks_and_builds_final_plan
    ...
    system_block = TavernKit::PromptBuilder::Block.new(
      role: :system,
      content: "AAA",
      token_budget_group: :system,
      removable: false,
    )
    history_block = TavernKit::PromptBuilder::Block.new(
      role: :assistant,
      content: "BBBB",
    ...
    ctx.instrumenter = TavernKit::PromptBuilder::Instrumenter::TraceCollector.new
