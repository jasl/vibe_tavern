...
class TavernKit::SillyTavern::PromptBuilder::Steps::PlanAssemblyTest < Minitest::Test
  ...
  def base_ctx(preset:, blocks:, generation_type: :normal, group: nil)
    TavernKit::PromptBuilder::State.new(
  ...
  def test_continue_prefill_appends_displaced_message_for_chat_dialects
    ...
    ctx = base_ctx(preset: preset, blocks: [], generation_type: :continue)
    ctx[:st_continue_prefill_block] = TavernKit::PromptBuilder::Block.new(
      role: :assistant,
      content: "A",
      slot: :chat_history,
  ...
  def test_continue_nudge_moves_last_chat_message_after_group_nudge_for_chat_dialects
    ...
    blocks = [
      TavernKit::PromptBuilder::Block.new(role: :user, content: "U", slot: :chat_history, token_budget_group: :history, removable: true),
      TavernKit::PromptBuilder::Block.new(role: :assistant, content: "A", slot: :chat_history, token_budget_group: :history, removable: true),
  ...
  def test_names_behavior_none_drops_message_names
    ...
    blocks = [
      TavernKit::PromptBuilder::Block.new(role: :assistant, name: "Alice", content: "A", slot: :chat_history, token_budget_group: :history, removable: true),
    ]
  ...
  def test_names_behavior_default_prefixes_non_user_names_in_group_chats
    ...
    blocks = [
      TavernKit::PromptBuilder::Block.new(role: :user, name: "Bob", content: "U", slot: :chat_history, token_budget_group: :history, removable: true),
      TavernKit::PromptBuilder::Block.new(role: :assistant, name: "Alice", content: "A", slot: :chat_history, token_budget_group: :history, removable: true),
    ]
