...
class TavernKit::SillyTavern::PromptBuilder::Steps::InjectionTest < Minitest::Test
  ...
  def test_continue_prefill_displaces_last_message_before_in_chat_injection_for_chat_dialects
    ...
    assert_instance_of TavernKit::PromptBuilder::Block, displaced
  ...
  def test_in_chat_prompt_entries_are_injected
    ...
    prompt_entries = [
      TavernKit::PromptBuilder::PromptEntry.new(id: "chat_history", pinned: true, role: :system),
      TavernKit::PromptBuilder::PromptEntry.new(id: "custom_chat", pinned: false, role: :system, position: :in_chat, depth: 1, content: "CUSTOM"),
    ]
  ...
  def test_authors_note_rewrites_persona_and_wraps_world_info_entries
    ...
    prompt_entries = [
      TavernKit::PromptBuilder::PromptEntry.new(id: "main_prompt", pinned: true, role: :system),
      TavernKit::PromptBuilder::PromptEntry.new(id: "authors_note", pinned: true, role: :system),
    ]
  ...
  def test_text_dialect_story_string_consumes_anchors_and_clears_replaced_groups
    ...
    ].map { |id| TavernKit::PromptBuilder::PromptEntry.new(id: id, pinned: true, role: :system) }
