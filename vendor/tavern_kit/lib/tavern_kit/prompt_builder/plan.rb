...
module TavernKit
  class PromptBuilder
    # A prompt plan is a sequence of PromptBuilder::Block objects.
    #
    ...
    class Plan
      ...
      #
      # This is intended for steps that need to adjust blocks or metadata
      ...
      def insert_at_index(index, block)
        unless block.is_a?(TavernKit::PromptBuilder::Block)
          raise ArgumentError, "block must be a TavernKit::PromptBuilder::Block"
        end
