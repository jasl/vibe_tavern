...
module AgentCore
  module PromptRunner
    ...
    class RunResult
      attr_reader :messages, :final_message, :turns, :usage, :tool_calls_made, :stop_reason
      ...
      def initialize(messages:, final_message:, turns:, usage: nil, tool_calls_made: [], stop_reason: :end_turn)
