  ...
  module SillyTavern
    module Lore
      ...
      class Engine < TavernKit::Lore::Engine::Base
        ...
        # Helper methods extracted to:
        # - `silly_tavern/lore/engine/buffer.rb`
        # - `silly_tavern/lore/engine/groups.rb`
      end
    end
  end
end

require_relative "engine/class_methods"
require_relative "engine/groups"
