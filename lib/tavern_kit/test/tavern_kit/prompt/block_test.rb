...
class TavernKit::Prompt::BlockTest < Minitest::Test
  ...
  def test_block_invalid_role
    assert_raises(ArgumentError) do
      TavernKit::Prompt::Block.new(role: :invalid, content: "test")
    end
  end
  ...
  def test_block_invalid_insertion_point
    assert_raises(ArgumentError) do
      TavernKit::Prompt::Block.new(role: :system, content: "test", insertion_point: :invalid)
    end
  end

  def test_block_invalid_budget_group
    assert_raises(ArgumentError) do
      TavernKit::Prompt::Block.new(role: :system, content: "test", token_budget_group: :invalid)
    end
  end
