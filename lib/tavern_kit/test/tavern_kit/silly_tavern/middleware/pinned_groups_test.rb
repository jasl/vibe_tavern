...
class TavernKit::SillyTavern::Middleware::PinnedGroupsTest < Minitest::Test
  ...
  def test_main_prompt_prefers_character_system_prompt_when_enabled
    ...
    entry = TavernKit::Prompt::PromptEntry.new(id: "main_prompt", pinned: true, role: :system)
  ...
  def test_persona_description_only_emits_for_in_prompt_position
    ...
    entry = TavernKit::Prompt::PromptEntry.new(id: "persona_description", pinned: true, role: :system)
  ...
  def test_character_personality_uses_format_only_when_personality_present
    ...
    entry = TavernKit::Prompt::PromptEntry.new(id: "character_personality", pinned: true, role: :system)
  ...
  def test_world_info_groups_apply_wi_format_and_ordering
    ...
    entry = TavernKit::Prompt::PromptEntry.new(id: "world_info_before_char_defs", pinned: true, role: :system)
  ...
  def test_chat_examples_emits_header_and_bundles
    ...
    entry = TavernKit::Prompt::PromptEntry.new(id: "chat_examples", pinned: true, role: :system)
